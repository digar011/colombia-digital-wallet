    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-text-primary">Citizen Management</h1>
            <p className="text-sm text-text-secondary mt-1">
              {formatNumber(mockCitizens.length)} total citizens &middot;{' '}
              {formatNumber(filteredCitizens.length)} showing
            </p>
          </div>
          ...
          <CardBody>
            <div className="flex flex-col md:flex-row gap-3">
              <div className="flex-1">
                <Input
                  placeholder="Search by name, document number, or email..."
                  leftIcon={Search}
                  value={searchQuery}
        ...
        {selectedIds.size > 0 && (
          <div className="flex items-center gap-3 bg-colombia-blue text-white px-4 py-3 rounded-xl animate-slide-up">
            <span className="text-sm font-medium">
              {selectedIds.size} citizen{selectedIds.size !== 1 ? 's' : ''} selected
            </span>
          ...
          {filteredCitizens.length > 0 && (
            <div className="flex flex-col sm:flex-row items-center justify-between gap-3 px-4 sm:px-6 py-4 border-t border-gray-200 bg-gray-50/50">
              <div className="flex items-center gap-2 text-sm text-text-secondary">
                ...
                <span>
                  of {formatNumber(filteredCitizens.length)} result
