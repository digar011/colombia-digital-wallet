...
export default function AuthError({ error, reset }: AuthErrorProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 text-center bg-surface dark:bg-gray-950 animate-fade-in">
      {/* Error icon */}
      ...
      <p className="text-sm text-text-secondary dark:text-text-secondary-dark mb-1 max-w-sm">
        Ha ocurrido un error al cargar la página de autenticación.
